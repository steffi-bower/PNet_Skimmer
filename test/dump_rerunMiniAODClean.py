...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/nbower/Events/SUSYGluGluToHToAA_AToBB_AToTauTau_M-12_FilterTauTauTrigger_TuneCP5_13TeV_madgraph_pythia8_MINIAOD/REGEN_SUSYGluGluToHToAA_AToBB_AToTauTau_M-12_FilterTauTauTrigger_TuneCP5_13TeV_madgraph_pythia8_MINIAOD_1.root'),
...
process.schedule = cms.Schedule(*[ process.TauReco, process.TauRecoElectronCleaned, process.TauRecoMuonCleaned, process.TauRecoBoosted, process.TauRecoLowPtElectronCleaned, process.slimpath, process.pileupjetidpath, process.main_path, process.tcpTrigNtupleMaker, process.tcpGenNtupleMaker, process.tcpNtupleMaker ])
